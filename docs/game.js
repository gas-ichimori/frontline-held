...
// ─── Enemy Definitions ───────────────────────────────────────────────────────
const EDEFS = [
  { id:'ant_s',    color:'#ff4422', edge:'#aa1100', r:12, hp:10,   depthSpd:0.000100, dmgMin:5,    dmgMax:10,  dropMin:0.10, dropMax:0.20 },
  ...
  { id:'spider_s', color:'#cc44ff', edge:'#7700aa', r:12, hp:15,   depthSpd:0.000070, dmgMin:7.5,  dmgMax:12.5,dropMin:0.15, dropMax:0.25 },
  ...
  { id:'bee_s',    color:'#ffcc00', edge:'#aa7700', r:10, hp:10,   depthSpd:0.000175, dmgMin:2.5,  dmgMax:5,   dropMin:0.075,dropMax:0.15 },
  { id:'bee_m',    color:'#ffcc00', edge:'#aa7700', r:17, hp:500,  depthSpd:0.000085, dmgMin:5,    dmgMax:20,  dropMin:0.10, dropMax:0.15 },
  { id:'bee_l',    color:'#ffaa00', edge:'#885500', r:30, hp:1000, depthSpd:0.000040, dmgMin:15,   dmgMax:30,  dropMin:0.15, dropMax:0.25 },
];

const DIFF_DROPS = {
  NORMAL: {
    ant_s:    { dropMin:0.25, dropMax:0.25 },
    ant_m:    { dropMin:0.25, dropMax:0.25 },
    ant_l:    { dropMin:0.35, dropMax:0.35 },
    spider_s: { dropMin:0.30, dropMax:0.30 },
    spider_m: { dropMin:0.30, dropMax:0.30 },
    spider_l: { dropMin:0.40, dropMax:0.40 },
    bee_s:    { dropMin:0.20, dropMax:0.20 },
    bee_m:    { dropMin:0.20, dropMax:0.20 },
    bee_l:    { dropMin:0.30, dropMax:0.30 },
  },
  EASY: {
    ant_s:    { dropMin:0.35, dropMax:0.35 },
    ant_m:    { dropMin:0.35, dropMax:0.35 },
    ant_l:    { dropMin:0.45, dropMax:0.45 },
    spider_s: { dropMin:0.40, dropMax:0.40 },
    spider_m: { dropMin:0.40, dropMax:0.40 },
    spider_l: { dropMin:0.50, dropMax:0.50 },
    bee_s:    { dropMin:0.30, dropMax:0.30 },
    bee_m:    { dropMin:0.30, dropMax:0.30 },
    bee_l:    { dropMin:0.40, dropMax:0.40 },
  },
};
